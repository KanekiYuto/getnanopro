...
````yaml post /v1/subscriptions/{id}/upgrade
paths:
      ...
      application/json:
        schemaArray:
          - type: object
            properties:
              ...
              update_behavior:
                allOf:
                  - type: string
                    description: >-
                      The update behavior for the subscription (defaults to
            ...
            required: true
            refIdentifier: '#/components/schemas/UpgradeSubscriptionRequestEntity'
            requiredProperties:
              - product_id
        examples:
          example:
