    ...
    <div className="bg-bg-elevated rounded-xl border border-border p-8">
      ...
      {!hasGenerations && (
        <div className="text-center py-16">
          ...
          <button className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary hover:bg-primary-hover text-white font-semibold transition-all cursor-pointer">
