  ...
  const modelOptions = [
    {
      value: 'flux-schnell',
      label: 'Flux Schnell',
      description: '快速生成，高质量输出',
    },
    {
      value: 'stable-diffusion',
      label: 'Stable Diffusion XL',
      description: '稳定的图像生成模型',
    },
    {
      value: 'dalle-3',
      label: 'DALL·E 3',
      description: '强大的创意图像生成',
    },
  ];
    ...
    const interval = setInterval(() => {
      setProgress((prev) => {
        if (prev >= 100) {
          ...
          // 模拟生成的图片
          setGeneratedImages([
            'https://via.placeholder.com/1024x1024/6633FF/FFFFFF?text=Generated+Image+1',
            'https://via.placeholder.com/1024x1024/00D4AA/FFFFFF?text=Generated+Image+2',
          ]);
          return 100;
        }
        return prev + 10;
